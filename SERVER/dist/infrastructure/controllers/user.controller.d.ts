...
export declare class UserController {
    ...
    constructor(createUserUseCase: CreateUserUseCase, updateUserUseCase: UpdateUserUseCase, findUserByCpfUseCase: FindUserByCpfUseCase, findUserByEmailUseCase: FindUserByEmailUseCase, findUserUseCase: FindUserUseCase);
